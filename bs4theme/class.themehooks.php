...
*/
class ZoteroDateTimeFormatter extends DateTimeFormatter {
...
Gdn::getContainer()->rule(DateTimeFormatter::class)->setClass(ZoteroDateTimeFormatter::class); // get(DateTimeFormatter::class);
